...
class GameRunner:
    ...
    pointData2 = [
        PointInfo([500, 50], 1, isFixed=True),
        PointInfo([-300, 50], 1, isFixed=True),
        PointInfo([-300, 400], 1, isFixed=True),
        PointInfo([300, 400], 1, isFixed=True),
    ]
    ...
    while Singleton.running:
        ...
        if line != None:
            pygame.draw.line(
                screen, [255, 0, 0], line.end1.getPosition(), line.end2.getPosition(), 5
            )
